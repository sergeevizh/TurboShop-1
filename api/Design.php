...
class Design extends Turbo
{
    ...
    public function resize_catalog_modifier($filename, $width=0, $height=0, $set_watermark=false)
    {
        ...
        return $this->config->root_url.'/'.$this->config->resized_category_images_dir.$resized_filename_encoded.'?'.$this->config->token($resized_filename);
    }
    ...
    public function resize_posts_modifier($filename, $width=0, $height=0, $set_watermark=false)
    {
        ...
        return $this->config->root_url.'/'.$this->config->resized_posts_images_dir.$resized_filename_encoded.'?'.$this->config->token($resized_filename);
    }
