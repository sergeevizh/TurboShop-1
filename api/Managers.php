...
{	
	public $permissions_list = array('products', 'categories', 'brands', 'features', 'orders', 'labels', 'callbacks',
		'users', 'groups', 'coupons', 'pages', 'menus', 'blog', 'comments', 'feedbacks', 'import', 'export', 
		'backup', 'stats', 'subscribes', 'design', 'banners', 'settings', 'currency', 'delivery', 'payment', 'managers', 'license');
