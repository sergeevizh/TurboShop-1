...
class Brands extends Turbo
{
	...
	*/
	public function get_brands($filter = array())
	{
		...
		// Выбираем все бренды
		$query = $this->db->placehold("SELECT DISTINCT b.id, b.name, b.url, b.visible, b.meta_title, b.meta_keywords, b.meta_description, b.description, b.image
	...
	*/
	public function get_brand($id)
	{
		...
		$query = "SELECT b.id, b.name, b.url, b.visible, b.meta_title, b.meta_keywords, b.meta_description, b.description, b.image
