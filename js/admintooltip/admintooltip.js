...
function show_tooltip()
{
	...
	{
		tooltipcontent = "<a href='turbo/index.php?module=ProjectsCategoryAdmin&id="+id+"&return="+from+"' class=admin_tooltip_edit>Редактировать</a>";
		tooltipcontent += "<a href='turbo/index.php?module=ProjectAdmin&return="+from+"' class=admin_tooltip_add>Добавить проект</a>";
	}
    
    if(id = $(this).attr('data-project'))
	{
		tooltipcontent = "<a href='turbo/index.php?module=ProjectAdmin&id="+id+"&return="+from+"' class=admin_tooltip_edit>Редактировать</a>";
	}
    
    if(id = $(this).attr('data-articles-category'))
	{
		tooltipcontent = "<a href='turbo/index.php?module=ArticlesCategoryAdmin&id="+id+"&return="+from+"' class=admin_tooltip_edit>Редактировать</a>";
		tooltipcontent += "<a href='turbo/index.php?module=ArticleAdmin&return="+from+"' class=admin_tooltip_add>Добавить статью</a>";
	}
    
    if(id = $(this).attr('data-article'))
	{
		tooltipcontent = "<a href='turbo/index.php?module=ArticleAdmin&id="+id+"&return="+from+"' class=admin_tooltip_edit>Редактировать</a>";
	}
