...
<form method="post" enctype="multipart/form-data" class="fn_fast_button">
            ...
            <div class="boxed fn_toggle_wrap min_height_230px">
                ...
                <div class="toggle_body_wrap fn_card on text-xs-center">
                    ...
                    <div class="banner_image text-xs-center">
                        ...
                        <img class="admin_banner_images" src="{$banners_image->image|resize_banners:465:465}" alt="" />
                        {/if}
                    </div>
        ...
        <div class="col-lg-6 col-md-12">
            <div class="boxed fn_toggle_wrap min_height_230px">
                ...
                <div class="toggle_body_wrap on fn_card">
                    <div class="">
                        <div class="heading_label" >Группа баннеров</div>
                    ...
                    <div class="">
                        <div class="heading_label">Адрес (url)</div>
                        <div class="">
                    ...
                    <div class="">
                        <div class="heading_label">Alt изображения</div>
                        <div class="">
                    ...
                    <div class="">
                        <div class="heading_label">Title изображения</div>
                        <div class="">
                    ...
                    <div class="">
                        <div class="heading_label">Описание</div>
                        <div class="">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 ">
            <button type="submit" class="btn btn_small btn_small_bottom btn_green float-md-right">
