...
<div class="row">
    <div class="col-lg-7 col-md-7">
        {if !$payment_method->id}
        <div class="heading_page">Добавление способа оплаты</div>
        {else}
                        ...
                        <div class="row">
                            <div class="col-lg-6 pr-0">
                                <div class="form-group clearfix">
                                    <div class="heading_label">Тип модуля:</div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group clearfix">
                                    <div class="heading_label">Валюта</div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group clearfix">
                                            <div class="boxes_inline">
                                                ...
                                                <label class="turbo_ckeckbox" for="{$setting->variable}"></label>
                                            </div>
                    ...
                    <div class="row wrap_payment_item">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="payment_item">
                                ...
                                <label for="id_{$delivery->id}" class="turbo_ckeckbox {if in_array($delivery->id, $payment_deliveries)}active_payment{/if}">
