...
<div class="boxed fn_toggle_wrap">
                    ...
                    <div class="fn_row {if $level == 1}turbo_list_body_item{/if} fn_sort_item body_narrow row_narrow">
                        <div class="turbo_list_row {if $level > 1}fn_sort_item{/if} narrow">
                            ...
                            <div class="turbo_list_boding turbo_list_check">
                                ...
                                <label class="turbo_ckeckbox" for="id_{$page->id}"></label>
							</div>
                            ...
                            <div class=" turbo_list_setting">
                                {*open*}
                                <a href="/{$page->url}" target="_blank" data-hint="Посмотреть на сайте" class="setting_icon setting_icon_open hint-bottom-middle-t-info-s-small-mobile  hint-anim">
    ...
    <div class="heading_box mt-1">
        <div class="text_grey">Нет страниц</div>
	</div>
    {/if}
</div>
<script>
