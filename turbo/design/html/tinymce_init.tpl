...
<script>
    $(function(){
        tinyMCE.init({literal}{{/literal}
			...
			mobile: {literal}{{/literal} 
			theme: 'mobile',
			toolbar: [ 'undo', 'redo', 'bold', 'italic', 'underline', 'fontsizeselect', 'styleselect', 'forecolor', 'bullist', 'numlist','link', 'unlink', 'image', 'removeformat' ]	
			{literal}}{/literal},
			min_height: 460,
            plugins: [
            ...
            toolbar: 'undo redo | formatselect | bold italic underline | alignleft aligncenter alignright alignjustify | bullist numlist | forecolor backcolor | link unlink  media image | removeformat preview fullscreen code',
            statusbar: false,
