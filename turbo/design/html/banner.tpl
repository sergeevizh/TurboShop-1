...
{else}
    {$meta_title = 'Новая группа баннеров' scope=parent}
{/if}
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-12">
                                <div class="mt-h">
                                    ...
                                    <span class="boxes_inline heading_label">Отображать группу на всех страницах</span>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-12">
                                <div class="input-group">
                                    <span class="boxes_inline heading_label">ID группы баннеров</span>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="boxed fn_toggle_wrap min_height_230px">
                <div class="heading_box">
                    Отображать баннеры на страницах:
                ...
                <div class="toggle_body_wrap fn_card on">
                    <div class="row">
                            ...
                            <div class="banner_card">
                                ...
                                <div class="banner_card_block">
                                    <select name="pages[]" class="selectpicker fn_action_select" multiple="multiple" data-selected-text-format="count">
                                        <option value="0" {if !$banner->page_selected || 0|in_array:$banner->page_selected}selected{/if}>Не отображать</option>
                            ...
                            <div class="banner_card">
                                ...
                                <div class="banner_card_block">
                                    <select name="categories[]" class="selectpicker" multiple="multiple" data-selected-text-format="count">
                                        <option value='0' {if !$banner->category_selected || 0|in_array:$banner->category_selected}selected{/if}>Не отображать</option>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="banner_card">
                                <div class="banner_card_header">
                                    <span class="font-weight-bold">Бренды</span>
                                </div>
                                <div class="banner_card_block">
                                    <select name="brands[]" class="selectpicker" multiple="multiple" data-selected-text-format="count">
                                        <option value='0' {if !$banner->brand_selected || 0|in_array:$banner->brand_selected}selected{/if}>Не отображать</option>
