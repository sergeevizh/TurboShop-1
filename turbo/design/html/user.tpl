            ...
            <div class="boxed fn_toggle_wrap">
                ...
                <div class="toggle_body_wrap on fn_card">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="mb-1">
                                <div class="heading_label">Группа</div>
                                <div class="">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="mb-1">
                                <div class="heading_label">Дата регистрации</div>
                                <div>
                                    <input name="email" class="form-control" type="text" disabled value="{$user->created|date}" />
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="mb-1">
                                <div class="heading_label">Последний IP</div>
                                <div>
                                    <input name="email"  class="form-control" type="text" disabled value="{$user->last_ip|escape}" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="">
                        <div class="turbo_list products_list turbo_list_order">
                            <div class="turbo_list_head">
                                ...
                                <div class="turbo_list_heading turbo_list_user_name">ФИО</div>
                                <div class="turbo_list_heading turbo_list_user_date">Дата</div>
                                <div class="turbo_list_heading turbo_list_user_price">Сумма</div>
                            </div>
