		...
		<div class="row">
			...
			<aside class="col-sm-3 border-left">
				<div class="action-wrap">
					...
					{else}
					<a class="wishlist-list" href="wishlist/{$product->url}"><i class="fa fa-heart text-white"></i> В избранное</a>
					{/if}
					</br>
					{if $smarty.session.compared_products && in_array($product->url, $smarty.session.compared_products)}
					<a href="compare"><i class="fa fa-chart-bar text-info"></i> В сравнении</a>
					{else}
					<a class="compare-list" href="compare/{$product->url}"><i class="fa fa-chart-bar text-white"></i> В сравнение</a>
					{/if}
				</div> 
			</aside> 
		</div> 
