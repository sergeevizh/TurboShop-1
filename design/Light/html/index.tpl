		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarsExample09">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					{if $user}
						<li class="nav-link"><i class="fa fa-user"></i> <a class="text-secondary card-link" href="user">{$user->name}</a></li>
						<li class="nav-link"><i class="fa fa-sign-in-alt"></i> <a class="text-secondary card-link" href="user/logout">Выйти</a></li>
					{else}
						<li class="nav-link"><i class="fa fa-sign-in-alt"></i> <a class="text-secondary card-link" href="user/login"> Вход</a></li>
						<li class="nav-link"><i class="fa fa-user-plus"></i> <a class="text-secondary card-link" href="user/register">Регистрация</a></li>
					{/if}
				</ul>
			</div>
			<!-- Корзина -->
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-6 mt-2">
				<h1 class="mt-4"><a class="text-dark card-link" href="/">Turbo Shop</a></h1>
			</div>
			<div class="col-lg-6 mt-2">
				<p class="text-right">(123) 456-78-90</br>
		...
		<div class="row">
			<div class="mobile-offcanvas col-lg-3 bg-white" id="sidebar">
				...
				<div id="all_brands">
					...
					<a class="btn btn-primary btn-sm mb-1" href="brands/{$b->url}">{$b->name}</a>
					{/foreach}
				</div>
				{/if}
				<!-- Все бренды (The End)-->
			...
			<div class="col-md-6 offset-md-3">  
				<form class="form-group my-5" id="loginForm" novalidate="" method="POST">
					...
					<div class="input-group mb-2">
						...
						<div class="input-group-append">
							<button type="submit" name="subscribe" value="Подписаться" id="btnLogin" class="btn btn-warning"><i class="fa fa-envelope"></i></button>
						</div>
					</div>  
				</form>
			</div>
		...
		<div class="container text-center text-md-left">
			...
			<div class="row text-center text-md-left mt-3 pb-3">
				...
				<div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
					...
					<p>Этот магазин является демонстрацией скрипта интернет-магазина Turbo. Все материалы на этом сайте присутствуют исключительно в демострационных целях.</p>
				</div>
				<!-- Grid column -->
				...
				<div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
					...
					<p><i class="fas fa-home mr-3"></i>г. Мой город, ул. Фруктовая 47, офис 217</p>
					<p><i class="fas fa-envelope mr-3"></i> info@gmail.com</p>
					<p><i class="fas fa-phone mr-3"></i> (123) 456-78-90</p>
					<p><i class="fas fa-print mr-3"></i> (123) 456-78-90</p>
				</div>
				<!-- Grid column -->
			</div>
			<!-- Footer links -->
			...
			<div class="row d-flex align-items-center">
				...
				<div class="col-md-7 col-lg-8">
					<!--Copyright-->
					<p class="text-center text-md-left">© <span itemprop="copyrightYear">{$smarty.now|date_format:"%Y"}</span> Copyright:
					...
					<div class="modal-body">
						...
						<div class="form-group has-feedback">									
							<div class="input-group">
								...
								<input type="text" name="name" value="{$comment_name}" data-format=".+" data-notice="Введите имя" id="nickname_field" value="" required class="form-control" placeholder="Имя" style=""/>
							</div>
						</div>							
						<div class="form-group has-feedback">									
							<div class="input-group">
