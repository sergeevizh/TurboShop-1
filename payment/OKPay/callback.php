...
if($_POST['ok_item_1_price'] != round($turbo->money->convert($order->total_price, $method->currency_id, false), 2) || $_POST['ok_item_1_price']<=0)
...
{
	header('Location: '.$turbo->request->root_url.'/order/');
	exit();
}
